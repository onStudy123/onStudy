      ...
      for(let i = 0; i<j; i++){
        ...
        await db.doc(path.path).get().then((doc) => {
            if (doc.exists){
              ...
              myCardCol += '<div class="col"><div class="card h-100 myCard" id="'+doc.id+'" onclick="video(\''+doc.id+'\')"><img src="'+doc.data().Video.thumbnail+'" class="card-img" alt="Video Thumbnail"><div class="card-body"><h3 class="card-title">'+doc.data().Video.title+'</h3><div class="video_type">';
              ...
              myCardCol += '</div><div class="user_wishlist"><i class="bx bxs-user"></i><i class="bx bxs-heart"></i></div><p class="card-text"><small class="text-muted">'+doc.data().Video.level+'</small></p><p class="card-text"><small class="text-muted">'+doc.data().Video.length+'</small></p><p class="card-text"><small class="text-muted">'+doc.data().Video.tutor+'</small></p><p class="card-text"><small class="text-muted">'+doc.data().Video.view;
